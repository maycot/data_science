...
def train_sess(sess, model_spec, num_steps, writer, params):
    ...
    # Load the training dataset into the pipeline and
...
def train_and_evaluate(train_model_spec, eval_model_spec,
    ...
    Args:
        ...
        params: (Params) contains hyperparameters of the models
        restore_from: (string) directory containing weights
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(begin_at_epoch, begin_at_epoch + params.num_epochs):
            ...
            if eval_acc >= best_eval_acc:
                ...
                # Save weights
                best_save_path = model_dir + '/best_weights/after-epoch'
                ...
                best_json_path = model_dir + '/metrics_eval_best_weights.json'
                save_dict_to_json(metrics, best_json_path)
            
            # Save latest eval metrics in a json file in the model directory
            last_json_path = model_dir + '/metrics_eval_last_weights.json'
