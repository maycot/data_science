DROP TABLE IF EXISTS fb00_uda03430.train_pec_tmp1;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_pec_tmp1
STORED AS ORC
AS SELECT DISTINCT
...
FROM fb00_uda03430.train_demandeurs_tmp3 B
INNER JOIN braff00.pr00_ppx005_ddiadh_priseencharge A
ON A.kn_individu_national = B.kn_individu_national
WHERE A.kd_datemodification <= '2020-12-20';

DROP TABLE IF EXISTS fb00_uda03430.train_pec_tmp2;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_pec_tmp2
STORED AS ORC
AS SELECT DISTINCT
...
FROM (SELECT *, RANK () OVER (
    ...
    fb00_uda03430.train_pec_tmp1) A
WHERE A.rk = 1;

DROP TABLE IF EXISTS fb00_uda03430.train_pec_tmp3;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_pec_tmp3
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
A.kd_datemodification,
...
A.dc_motifinscription_id,
A.dc_situationanterieure_id
FROM fb00_uda03430.train_pec_tmp1 A
...
DROP TABLE IF EXISTS fb00_uda03430.train_pec_tmp4;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_pec_tmp4
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
...
FROM (SELECT *, RANK () OVER (
    ...
    kn_numpec DESC) AS rk FROM fb00_uda03430.train_pec_tmp2) A
WHERE A.rk = 2;

DROP TABLE IF EXISTS fb00_uda03430.train_pec_count;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_pec_count
STORED AS ORC
AS SELECT
...
FROM fb00_uda03430.train_pec_tmp2
GROUP BY kn_individu_national;

DROP TABLE IF EXISTS fb00_uda03430.train_pec;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_pec
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
A.dc_typepec_id,
A.dc_soustypepec,
DATEDIFF(A.dd_dateinscriptionpec, '2020-12-20') AS delta_dateinscriptionpec,
A.dc_categoriede_id,
A.dc_motifinscription_id,
A.dc_situationanterieure_id,
B.previous_typepec,
DATEDIFF(B.previous_dateinscriptionpec, '2020-12-20') AS delta_previous_dateinscriptionpec,
...
C.ale_count,
C.numpec_count
FROM fb00_uda03430.train_pec_tmp3 A
LEFT JOIN fb00_uda03430.train_pec_tmp4 B
ON A.kn_individu_national = B.kn_individu_national
LEFT JOIN fb00_uda03430.train_pec_count C
ON A.kn_individu_national = c.kn_individu_national;

-- Données indemnisation : capital and duree

-- 1) inner join
DROP TABLE IF EXISTS fb00_uda03430.train_indemnisation_tmp1;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_indemnisation_tmp1
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
...
ON A.kn_individu_national = B.kn_individu_national
WHERE TO_DATE(B.kd_datemodification) <= '2020-12-20';

DROP TABLE IF EXISTS fb00_uda03430.train_indemnisation_tmp2;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_indemnisation_tmp2
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
A.montant_indem,
...
FROM (SELECT *, RANK () OVER (
        ...
        ORDER BY kd_datemodification DESC) AS rk FROM
    fb00_uda03430.train_indemnisation_tmp1) A
WHERE A.rk = 1;

DROP TABLE IF EXISTS fb00_uda03430.train_indemnisation_tmp3;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_indemnisation_tmp3
STORED AS ORC
AS SELECT
A.kn_individu_national,
COUNT(DISTINCT A.kc_ouverturedroit) as ouverturedroit_count,
COUNT(DISTINCT A.kc_reprisedroit) as reprisedroit_count
FROM fb00_uda03430.train_indemnisation_tmp2 A
GROUP BY A.kn_individu_national;

DROP TABLE IF EXISTS fb00_uda03430.train_indemnisation_tmp4;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_indemnisation_tmp4
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
A.montant_indem,
...
FROM (SELECT *, RANK () OVER (
    ...
    fb00_uda03430.train_indemnisation_tmp2) A
WHERE A.rk = 1;

DROP TABLE IF EXISTS fb00_uda03430.train_indemnisation;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_indemnisation
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
A.montant_indem,
A.duree_indem,
A.date_fin_indem,
DATEDIFF(A.date_fin_indem, '2020-12-20') AS delta_fin_indem,
B.ouverturedroit_count,
B.reprisedroit_count
FROM fb00_uda03430.train_indemnisation_tmp4 A
INNER JOIN fb00_uda03430.train_indemnisation_tmp3 B
ON A.kn_individu_national = B.kn_individu_national;

-- Données de type ami entrants

-- Récupération des ami des bni
DROP TABLE IF EXISTS fb00_uda03430.train_ami_tmp1;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_ami_tmp1
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
B.kn_ami,
...
WHERE B.dd_datecreation < '2020-12-20';

-- Sélection des ami avec le premier échange en provenance du DE
DROP TABLE IF EXISTS fb00_uda03430.train_ami_tmp2;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_ami_tmp2
STORED AS ORC
AS SELECT
A.kn_individu_national,
A.kn_ami
FROM fb00_uda03430.train_ami_tmp1 A
INNER JOIN (SELECT * , RANK() OVER (
        PARTITION BY dn_ami
...
DROP TABLE IF EXISTS fb00_uda03430.train_ami;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_ami
STORED AS ORC
AS SELECT
A.kn_individu_national,
COUNT(DISTINCT A.kn_ami) AS ami_entrants_count
FROM fb00_uda03430.train_ami_tmp2 A
GROUP BY A.kn_individu_national;

-- Activité déclarée table actualisation

DROP TABLE IF EXISTS fb00_uda03430.train_actu_tmp1;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_actu_tmp1
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
A.kc_individu_local,
...
WHERE TO_DATE(CONCAT(20, B.kc_anneeactualisation , '-', B.kc_moisactualisation, '-00')) <= '2020-12-20'
AND TO_DATE(CONCAT(20, B.kc_anneeactualisation , '-', B.kc_moisactualisation, '-00')) >= DATE_SUB('2020-12-20', 180);

DROP TABLE IF EXISTS fb00_uda03430.train_actu_tmp2;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_actu_tmp2
STORED AS ORC
AS SELECT
A.kn_individu_national,
A.kc_individu_local,
...
FROM (SELECT kn_individu_national, kc_individu_local,
    ...
    FROM fb00_uda03430.train_actu_tmp1
    WHERE dateactu >= DATE_SUB('2020-12-20', 90)
...
INNER JOIN (SELECT kn_individu_national, kc_individu_local,
    ...
    FROM fb00_uda03430.train_actu_tmp1
    WHERE dateactu >= DATE_SUB('2020-12-20', 180)
...
DROP TABLE IF EXISTS fb00_uda03430.train_actu_tmp3;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_actu_tmp3
STORED AS ORC
AS SELECT
A.kn_individu_national,
A.h_trav_m,
...
FROM (SELECT * , RANK() OVER (PARTITION BY kn_individu_national
        ORDER BY dateactu DESC) AS rk FROM fb00_uda03430.train_actu_tmp1) A
WHERE A.rk = 1;

DROP TABLE IF EXISTS fb00_uda03430.train_actu;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_actu
STORED AS ORC
AS SELECT
A.kn_individu_national,
A.h_trav_m,
...
B.six_months_h_trav,
B.six_months_s_trav
FROM fb00_uda03430.train_actu_tmp3 A
LEFT JOIN fb00_uda03430.train_actu_tmp2 B
ON A.kn_individu_national = B.kn_individu_national;

-- Periodes activité gaec

DROP TABLE IF EXISTS fb00_uda03430.train_gaec_tmp1;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_gaec_tmp1
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
...
ON A.kn_individu_national = B.kn_individu_national
WHERE B.dd_datedebutactivite < '2020-12-20';

DROP TABLE IF EXISTS fb00_uda03430.train_gaec_tmp2;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_gaec_tmp2
STORED AS ORC
AS SELECT
kn_individu_national,
...
FROM fb00_uda03430.train_gaec_tmp1
GROUP BY kn_individu_national;

DROP TABLE IF EXISTS fb00_uda03430.train_gaec_tmp3;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_gaec_tmp3
STORED AS ORC
AS SELECT
A.kn_individu_national,
...
FROM fb00_uda03430.train_gaec_tmp1 A
WHERE dd_datedebutactivite >= DATE_SUB('2020-12-20', 90)
AND dc_typeperiodegaec_id IN (15, 16, 17, 18, 2, 4, 7, 9)
GROUP BY kn_individu_national;

DROP TABLE IF EXISTS fb00_uda03430.train_gaec_tmp4;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_gaec_tmp4
STORED AS ORC
AS SELECT
A.kn_individu_national,
...
FROM fb00_uda03430.train_gaec_tmp1 A
WHERE dd_datedebutactivite >= DATE_SUB('2020-12-20', 180)
AND dc_typeperiodegaec_id IN (15, 16, 17, 18, 2, 4, 7, 9)
GROUP BY kn_individu_national;


DROP TABLE IF EXISTS fb00_uda03430.train_gaec_tmp5;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_gaec_tmp5
STORED AS ORC
AS SELECT
kn_individu_national,
...
DROP TABLE IF EXISTS fb00_uda03430.train_gaec_tmp6;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_gaec_tmp6
STORED AS ORC
AS SELECT
kn_individu_national,
...
DROP TABLE IF EXISTS fb00_uda03430.train_gaec_tmp7;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_gaec_tmp7
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
DATEDIFF(A.dd_datefinactivite, '2020-12-20') AS delta_last_periodeact,
...
DROP TABLE IF EXISTS fb00_uda03430.train_gaec;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_gaec
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
...
FROM fb00_uda03430.train_gaec_tmp7 A
LEFT JOIN fb00_uda03430.train_gaec_tmp2 B
ON A.kn_individu_national = B.kn_individu_national
LEFT JOIN fb00_uda03430.train_gaec_tmp3 C
ON A.kn_individu_national = C.kn_individu_national
LEFT JOIN fb00_uda03430.train_gaec_tmp4 D
ON A.kn_individu_national = D.kn_individu_national
LEFT JOIN fb00_uda03430.train_gaec_tmp5 E
ON A.kn_individu_national = E.kn_individu_national
LEFT JOIN fb00_uda03430.train_gaec_tmp6 F
ON A.kn_individu_national = F.kn_individu_national;

-- Données de type formation et diplôme

DROP TABLE IF EXISTS fb00_uda03430.train_dipl_tmp1;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_dipl_tmp1
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
B.kn_idformation,
...
ON A.kn_individu_national = B.kn_individu_national
WHERE B.kd_datemodification < '2020-12-20'
AND B.dn_topobtentiondiplome = True
AND B.rk = 1;

DROP TABLE IF EXISTS fb00_uda03430.train_dipl_tmp2;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_dipl_tmp2
STORED AS ORC
AS SELECT
A.kn_individu_national,
...
FROM fb00_uda03430.train_dipl_tmp1 A
GROUP BY A.kn_individu_national;

DROP TABLE IF EXISTS fb00_uda03430.train_dipl_tmp3;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_dipl_tmp3
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
...
FROM (SELECT * , RANK() OVER (
    ...
    fb00_uda03430.train_dipl_tmp1) A
WHERE A.rk = 1;

DROP TABLE IF EXISTS fb00_uda03430.train_dipl;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_dipl
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
A.last_domforma,
...
B.typeforma_count,
B.domforma_count
FROM fb00_uda03430.train_dipl_tmp3 A
LEFT JOIN fb00_uda03430.train_dipl_tmp2 B
ON A.kn_individu_national = B.kn_individu_national;

-- Données de type profil professionnel

DROP TABLE IF EXISTS fb00_uda03430.train_dcopro_tmp1;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_dcopro_tmp1
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
...
DROP TABLE IF EXISTS fb00_uda03430.train_dcopro_tmp2;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_dcopro_tmp2
STORED AS ORC
AS SELECT
A.kn_individu_national,
COUNT(DISTINCT A.rome_profil) AS rome_profil_count
FROM fb00_uda03430.train_dcopro_tmp1 A
GROUP BY A.kn_individu_national;

DROP TABLE IF EXISTS fb00_uda03430.train_dcopro_tmp3;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_dcopro_tmp3
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
A.rome_profil,
...
FROM (SELECT *, RANK () OVER (
    ...
    fb00_uda03430.train_dcopro_tmp1) A
WHERE A.rk = 1;

DROP TABLE IF EXISTS fb00_uda03430.train_features_rome_proche_tmp1;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_features_rome_proche_tmp1
STORED AS ORC
AS SELECT DISTINCT
A.rome2
...
DROP TABLE IF EXISTS fb00_uda03430.train_features_rome_proche;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_features_rome_proche
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
1 as has_rome_proche
FROM fb00_uda03430.train_dcopro_tmp3 A
INNER JOIN fb00_uda03430.train_features_rome_proche_tmp1 B
ON A.rome_profil = B.rome2;

DROP TABLE IF EXISTS fb00_uda03430.train_dcopro;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_dcopro
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
A.rome_profil,
...
C.has_rome_proche
FROM fb00_uda03430.train_dcopro_tmp3 A
INNER JOIN fb00_uda03430.train_dcopro_tmp2 B
ON A.kn_individu_national = B.kn_individu_national
LEFT JOIN fb00_uda03430.train_features_rome_proche C
ON A.kn_individu_national = C.kn_individu_national;

-- Features

DROP TABLE IF EXISTS fb00_uda03430.train_features_tmp1;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_features_tmp1
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
A.dep,
...
K.domforma_count
FROM fb00_uda03430.train_demandeurs_tmp3 A
LEFT JOIN fb00_uda03430.train_dsn_prealable_tmp7 G
ON A.kn_individu_national = G.kn_individu_national
LEFT JOIN fb00_uda03430.train_pec B
ON A.kn_individu_national = B.kn_individu_national
LEFT JOIN fb00_uda03430.train_indemnisation C
ON A.kn_individu_national = C.kn_individu_national
LEFT JOIN fb00_uda03430.train_dcopro D
ON A.kn_individu_national = D.kn_individu_national
LEFT JOIN fb00_uda03430.train_ami E
ON A.kn_individu_national = E.kn_individu_national
LEFT JOIN fb00_uda03430.train_label F
ON A.kn_individu_national = F.kn_individu_national
-- LEFT JOIN fb00_uda03430.train_dsn_ulterieure_tmp7 H
-- ON A.kn_individu_national = H.kn_individu_national
LEFT JOIN fb00_uda03430.train_actu I
ON A.kn_individu_national = I.kn_individu_national
LEFT JOIN fb00_uda03430.train_gaec J
ON A.kn_individu_national = J.kn_individu_national
LEFT JOIN fb00_uda03430.train_dipl K
ON A.kn_individu_national = K.kn_individu_national;


DROP TABLE IF EXISTS fb00_uda03430.train_features;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_features
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
A.dep,
...
FROM fb00_uda03430.train_features_tmp1 A
...
beeline -u 'jdbc:hive2://hp1edge02.pole-emploi.intra:2181,hp1namenode01.pole-emploi.intra:2181,hp1namenode02.pole-emploi.intra:2181/database;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2;' --outputformat=dsv -e 'select * from fb00_uda03430.train_features' > /donapp/uda034/p00/dat/features_2020_D1106.csv


DROP TABLE IF EXISTS fb00_uda03430.naf_ref;
CREATE TABLE IF NOT EXISTS fb00_uda03430.naf_ref
STORED AS ORC
AS SELECT DISTINCT
kc_nafrev2,
dc_lblnafrev2
FROM braff00.pr00_ppx005_ref_nafrev2;

beeline -u 'jdbc:hive2://hp1edge02.pole-emploi.intra:2181,hp1namenode01.pole-emploi.intra:2181,hp1namenode02.pole-emploi.intra:2181/database;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2;' --outputformat=dsv -e 'select * from fb00_uda03430.naf_ref' > /donapp/uda034/p00/dat/naf_ref.csv

DROP TABLE IF EXISTS fb00_uda03430.pcs_ref;
CREATE TABLE IF NOT EXISTS fb00_uda03430.pcs_ref
STORED AS ORC
AS SELECT DISTINCT
kc_profcatsoc,
dc_lblprofcatsoc
FROM braff00.pr00_pdsnpe_ref_profcatsoc;

beeline -u 'jdbc:hive2://hp1edge02.pole-emploi.intra:2181,hp1namenode01.pole-emploi.intra:2181,hp1namenode02.pole-emploi.intra:2181/database;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2;' --outputformat=dsv -e 'select * from fb00_uda03430.pcs_ref' > /donapp/uda034/p00/dat/pcs_ref.csv

DROP TABLE IF EXISTS fb00_uda03430.domforma_ref;
CREATE TABLE IF NOT EXISTS fb00_uda03430.domforma_ref
STORED AS ORC
AS SELECT DISTINCT
kc_domaineformation,
dc_lbldomaineformation
FROM braff00.pr00_ppx005_ref_domaineformation;

beeline -u 'jdbc:hive2://hp1edge02.pole-emploi.intra:2181,hp1namenode01.pole-emploi.intra:2181,hp1namenode02.pole-emploi.intra:2181/database;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2;' --outputformat=dsv -e 'select * from fb00_uda03430.domforma_ref' > /donapp/uda034/p00/dat/domforma_ref.csv

DROP TABLE IF EXISTS fb00_uda03430.train_comp;
CREATE TABLE IF NOT EXISTS fb00_uda03430.train_comp
STORED AS ORC
AS SELECT DISTINCT
A.kn_individu_national,
A.label,
...
D.dc_specificiterome79,
D.dc_specificiterome80
FROM fb00_uda03430.train_features A
INNER JOIN (SELECT *, RANK () OVER (
        PARTITION BY kn_individu_national
        ORDER BY kd_datemodification DESC, kc_profilde DESC) AS rk FROM
    braff00.pr00_ppx005_dcopro_profilprofessionnel) B
ON A.kn_individu_national = B.kn_individu_national
WHERE B.rk = 1;

beeline -u 'jdbc:hive2://hp1edge02.pole-emploi.intra:2181,hp1namenode01.pole-emploi.intra:2181,hp1namenode02.pole-emploi.intra:2181/database;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2;' --outputformat=dsv -e 'select * from fb00_uda03430.train_comp' > /donapp/uda034/p00/dat/comp_D1106.csv
