...
def main(train_df, valid_df, code_rome):
    ...
    train_model_classifier = train_logistic_regression_classifier if label_percent <= 0.1 else train_random_forest_classifier
    # Resample train set
    train_df['label'] = train_df['label'].astype(int)
    print(train_model_classifier)
    ...
    # X_valid, y_valid = build_X_y_arrays(valid_df, TARGET_FEATURE,
    #                                     CATEGORICAL_FEAT_LIST, NUMERICAL_FEAT_LIST)
    ...
    # profils_df.to_csv('./data/candidats_' + code_rome + '.csv',
    #                   index=False, sep='|')
    return profils_df
